...
public class Login_Obj extends BaseClass{
	...
	@FindBy (xpath = "//*[contains(text(),'Forgot username Password')]") WebElement forgotUnamePswdLinkBtn;
	@FindBy (tagName = "h1") WebElement emailField;
	@FindBy (xpath = "//*[@class='btn btn-info']") WebElement sendLink_btn;
	@FindBy (xpath = "//*[@class='submit btn-info']") WebElement submit_btn;
	@FindBy (xpath = "//*[contains(text(),'Type Password)]") WebElement typeNewPswd_txt;
	@FindBy (xpath = "//*[contains(text(),'ReType Password)]") WebElement reTypeNewPswd_txt;
	@FindBy (xpath = "//*[contains(text(),' alert)]") WebElement alertText;
