...
When Admin clicks "Assignment" button on the navigation bar
  ...
  @Verify_right_arrow_is_disable
  Scenario: Verify  right arrow is disable when sheet two is displayed in data table when entries are less than 10 in Manage Assignment Page
 Then Data table should display  page 1  when entries available in Manage Assignment Page
